...
# Botones Nexys4
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { data_BTN[0] }]; # BTNC
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { data_BTN[1] }]; # BTNU
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { data_BTN[2] }]; # BTNL
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { data_BTN[3] }]; # BTNR
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { data_BTN[4] }]; # BTND
